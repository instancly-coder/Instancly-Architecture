...
// by `GET /api/templates`. Reachable from:
//   - the homepage "View all" link in the templates section,
//   - the admin templates page's "Open public /explore →" link,
//   - the global mobile drawer "Explore" entry,
//   - the dashboard sidebar "Explore" entry.
//
